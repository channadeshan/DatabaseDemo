...
namespace WebStore.Migrations
{
    ...
    [Migration("20250419194305_AddDiscountCode3")]
    partial class AddDiscountCode3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebStore.Entities.Address", b =>
                {
                    ...
                    b.HasIndex(new[] { "CustomerId" }, "IX_addresses_customer_id");
            ...
            modelBuilder.Entity("WebStore.Entities.Category", b =>
                {
                    ...
                    b.HasIndex(new[] { "ParentCategoryId" }, "IX_categories_parent_category_id");
            ...
            modelBuilder.Entity("WebStore.Entities.Order", b =>
                {
                    ...
                    b.HasIndex(new[] { "BillingAddressId" }, "IX_orders_billing_address_id");

                    b.HasIndex(new[] { "CustomerId" }, "IX_orders_customer_id");

                    b.HasIndex(new[] { "ShippingAddressId" }, "IX_orders_shipping_address_id");
